...
<html>
    ...
    <body>
        ...
        <div class="formBox">
            <form action="patientCntrl.jsp" onsubmit="return datavalid()" name="changePasswordForm" method="POST">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                                <input  style="float:right; width: 100px; margin-top: 10px" type="button" name="changePassword" value="Back" onclick="window.location.href = 'patientProfile.jsp'">
                        </td>
                    </tr>
                </table>
            </form>
